      ...
      <section className='tariffs__cost'>
        ...
        <div className='tariffs__cost-container'>
          <p className='tariffs__text'>
            ...
            то цена выйдет не меньше 100 тысяч рублей, но скажу по секрету - на одно интервью 
            уходит больше одного часа.
          </p>
          <p className='tariffs__text'>
