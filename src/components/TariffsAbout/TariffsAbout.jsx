  ...
  return (
      <section className='tariffs__about'>
        ...
        <div className='tariffs__text-container'>
          <p className='tariffs__text'>Если мы еще не знакомы - привет, меня зовут Айвар 👋 </p>
          ...
          <p className='tariffs__text'>
            Ты спросишь зачем нам это? Тут все просто - мы хотим помочь вырасти в карьере 
          ...
          <p className='tariffs__text quotation'>
            Для понимания - я из Сургута, переехал учиться в Москву в 17 лет, в Москве у меня не было ни родственников, ни связей. 
            Прожил в общаге 5 лет и все это время невероятно мечтал добиться хорошей жизни.
          </p>
          <p className='tariffs__text'>
            И это дало мега результат - в 2024 году я занял должность руководителя направления развития операций 
