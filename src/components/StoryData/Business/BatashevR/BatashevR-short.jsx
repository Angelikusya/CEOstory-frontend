    ...
    return (
        <article className='story-content'>
            ...
            <div className='batashov-short__story'>
                ...
                <div className='batashov-short__text-container'>
                    <p className='short-text'>
                        Основной источник заказов &mdash; это партнеры, которые получают комиссионные в 5 &mdash; 10% от суммы сделки, среди них архитекторы,  
                ...
                <div className='batashov-short__quoute'>
                    ...
                    <p className='short-text'>
                        ...
                        какую бы excel-табличку не создал &mdash;клиенты не пойдут.                   
                    </p>
                </div>
                ...
                <div className='batashov-short__text-container'>
                    ...
                    <p className='short-text'>
                        Все зависит от количества проектов, но такая компания &mdash; это обычно:                     
                    </p>
                    <ul className='batashov-short__list-bulits'>
                ...
                <div className='batashov-short__text-container'>
                    ...
                    <p className='short-text'>
                        Основная проблема тут &mdash; это поиск качественных монтажников, хорошие ребята всегда заняты.                    </p>
                </div>
                <div className='batashov-short__quoute'>
                    <div className='batashov-short__quoute-img'></div>
                    <p className='short-text'>
                ...
                <div className='batashov-short__text-container'>
                    <p className='short-text'>
                        Поставщики оборудования для “умных домов” общедоступны, и они охотно работают с любыми компаниями &mdash; как 
                        с начинающими, так и с продвинутыми.
                    </p>
                    <p className='short-text'>
                        Если у тебя хороший заказ, то тебе всегда дадут хорошие условия &mdash; неважно сколько ты у них заказывал и заказывал ли вообще.
                    </p>
                    <p className='short-text'>
                ...
                <div className='batashov-short__text-container'>
                    <ul className='batashov-short__list-numbers'>
                        ...
                        <li className='batashov-short__number short-text'>
                            4. Хороший проект &mdash; это залог успеха, поэтому на него лучше не скупиться.
                        </li>
                        <li className='batashov-short__number short-text'>
