...
const BatashevR = ({ 
  ...
  const story = DATA.find(story => story.storyId === 2);
  const storyId = 2;
        ...
        <div className='story'>
          ...
          {isMobile ? (
            <div className='story__main-mobile'>
              <div className='story__main-mobile-container'> 
                <img className='story__story__main-mobile-photo green' src={BatashevPhoto} alt={story.name}/>
          ...
          <div className='story__buttons '>
            ...
            >
              ...
              <p className='story__button-text'>
                Краткая инструкция по открытию бизнеса, чтобы с нуля добиться того же самое
              </p>
            </button>
            <button 
            ...
            >
             <p className={`story__button-title mini ${!isShort ? 'active' : ''}`} >Весь путь героя</p>
              <p className='story__button-text mini'>
                Полное интервью с героем, чтобы узнать все его секреты
              </p>
            </button>
          </div>
          )}
