              ...
              <div className={`tariffs__dropdown-content ${expandedIndex === index ? 'show' : ''}`}>
                ...
                <div className='tarrifs__dropdown-list'>
                  <p className='tarrifs__dropdown-text'>
                    Буквально все, до которых мы успели дотянуться. Нам важна не столь сфера, сколько пример успешного человека, его путь 
                    к успеху и советы, благодаря которым любой сможет повторить его опыт.
                  </p>
                  <p className='tarrifs__dropdown-text'>
                    На странице со списком историй есть фильтр “Сфера”, благодаря которому можно выбрать то, что интересует именно тебя, 
                    а благодаря фильтру “Карьера или бизнес” можно выбрать что тебе ближе &mdash; становление топ-менеджером или открытие 
                    и развитие собственного дела.
                  </p>
                </div>
                ...
                {index === 1 && (
                  <div className='tarrifs__dropdown-list'>
                    <p className='tarrifs__dropdown-text'>
                      Мы собираем истории только от топовых ребят в карьере и бизнесе и стараемся выяснить саму суть их успеха &mdash; все то, 
                ...
                <div className='tarrifs__dropdown-list'>
                  <p className='tarrifs__dropdown-text'>
                    Да, определенно да. “CEOstory” &mdash; это место, где ты можешь найти сотни идей и черпать вдохновение. 
                ...
                {index === 3 && (
                  <div className='tarrifs__dropdown-list'>
                    <p className='tarrifs__dropdown-text'>
                      100% да, ведь ты сможешь использовать советы для развития карьеры или бизнеса от других успешных ребят, 
                      у которых получилось достигнуть высот в своей области.
                    </p>
                </div>
                )}
            </div>
