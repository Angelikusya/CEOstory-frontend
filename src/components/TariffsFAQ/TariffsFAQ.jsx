            ...
            <div className='tariffs_dropdown-block'>
              ...
              <div className={`tariffs__dropdown-content ${expandedIndex === index ? 'show' : ''}`}>
                ...
                <div className='tarrifs__dropdown-list'>
                  ...
                  <p className='tarrifs__dropdown-text'>
                    На страницах со списком историй есть фильтр “Сфера”, благодаря которому можно выбрать то, что интересует 
                    именно тебя, а переключаясь между разделами “Истории в карьере” и “Истории в бизнесе” можно выбрать, 
                    что тебе ближе: становление топ-менеджером или открытие и развитие собственного дела.
                  </p>
                </div>
